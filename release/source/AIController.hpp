...
public:
	...
	cugl::Vec2 getMovement(shared_ptr<BaseEnemyModel> e, cugl::Vec2 player_pos);
	...
	cugl::Vec2 getSpecterMovement(shared_ptr<BaseEnemyModel> specter, cugl::Vec2 player_pos);
